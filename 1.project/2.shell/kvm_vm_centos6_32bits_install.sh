...
virt-install --name ${HOST} --ram=1024 --vcpus=2  --os-variant=rhel6  --disk=/kvm/${HOST}/${HOST}.qcow2,size=50,format=qcow2,bus=virtio –-keymap=en-us     --location=http://10.1.166.20/ISO/centos6_x86/ --extra-args="ks=http://10.1.166.20/ks.6.5.cfg"   --bridge=virbr0,model=virtio 
